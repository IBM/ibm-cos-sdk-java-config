...
package com.ibm.cloud.objectstorage.common;
...
public class SdkCommon {
    ...
    private static String versionPropsFile = "objectstorage";
    ...
    protected static void readBuildProperties() {
        ...
        try (InputStream is = SdkCommon.class.getResourceAsStream("/" + versionPropsFile + ".properties")) {
            buildProps.load(is);
     ...
     *
     * @param serviceName
     *            the name of the service as defined in the API definition (e.g. "objectstorage")
