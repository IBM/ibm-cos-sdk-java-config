...
public class RestoresPager {
   ...
   * @param client the ResourceConfiguration instance to be used to invoke the "listRestores" method
   * @param options the ListRestoresOptions instance to be used to invoke the "listRestores" method
   */
   ...
   * @return a List&lt;Restore&gt; that contains the next page of results
   */
  public List<Restore> getNext() {
    if (!hasNext()) {
      throw new NoSuchElementException("No more results available");
    }

    ListRestoresOptions.Builder builder = this.options.newBuilder();
    if (this.pageContext.getNext() != null) {
      builder.token(this.pageContext.getNext());
    }
    this.options = builder.build();

    RestoreCollection result = client.listRestores(options).execute().getResult();
    ...
    return result.getRestores();
  }

  /**
   * Returns all results by invoking getNext() repeatedly until all pages of results have been retrieved.
   * @return a List&lt;Restore&gt; containing all results returned by the "listRestores" method
   */
  public List<Restore> getAll() {
    List<Restore> results = new ArrayList<>();
    while (hasNext()) {
      List<Restore> nextPage = getNext();
